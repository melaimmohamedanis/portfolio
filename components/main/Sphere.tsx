...
// @ts-ignore  
import ts from 'simple-icons/icons/typescript.js'
// @ts-ignore  
import js  from 'simple-icons/icons/javascript.js'
// @ts-ignore  

import allIcons from "simple-icons";
import {IconCloud, IconTag, Tag, Cloud, TagCanvasOptions } from 'react-icon-cloud'
...
export default function Sphere() {
  const [background, setBackground] = React.useState<string>('#ffffff00')
...
<IconCloud
    ...
    />
      ...
      <button onClick={toggleBg}>Toggleffffffff Theme</button>
